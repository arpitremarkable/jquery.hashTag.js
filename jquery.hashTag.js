...
Array.prototype.sub = function(arr) {
  ...
  return (function() {
    ...
    for (_i = 0, _len = this.length; _i < _len; _i++) {
      x = this[_i];
      if (__indexOf.call(arr, x) < 0) _results.push(x);
    }
    return _results;
  }).call(this);
};
...
Array.prototype.set = function() {
  ...
  for (_i = 0, _len = this.length; _i < _len; _i++) {
    x = this[_i];
    if (__indexOf.call(arr, x) < 0) arr.push(x);
  }
  return arr;
};
...
HashTag = (function() {
  ...
  function HashTag($target, options) {
    ...
    if (this.clearAtLoad) this.old_hash = [];
    ...
    $target[this.event](function(e) {
      ...
      if (!multi) _this.removeHash(_this.hash.sub([tag]));
      if (toggle) {
  ...
  HashTag.prototype.addHash = function(hash) {
    ...
    if (typeof hash !== 'object') hash = [hash];
  ...
  HashTag.prototype.splitHash = function(hash) {
    ...
    return (function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        tag = _ref[_i];
        if (Boolean(tag)) _results.push(tag);
      }
      return _results;
    })();
  };
